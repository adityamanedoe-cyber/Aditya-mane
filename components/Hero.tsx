      ...
      <div className="relative z-10 max-w-6xl space-y-12">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 pt-8 opacity-0 animate-reveal" style={{ animationDelay: '2.9s' }}>
          ...
          <button 
            ...
            className="group glass-card h-16 px-10 rounded-full flex items-center justify-center gap-3 border-white/10 hover:border-white/20 transition-all hover:scale-105 active:scale-95 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]"
          >
